...
"}")
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 125, 102))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("data/emoji_clicker/apple.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.clicker_button.setIcon(icon)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("qt_icons/heart.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.life_button.setIcon(icon1)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/qt_icons/headphones.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.dino_button.setIcon(icon2)
        self.dino_button.setIconSize(QtCore.QSize(16, 16))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("qt_icons/chevron-down.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("qt_icons/users.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.authors_button.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("qt_icons/settings.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("qt_icons/external-link.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("qt_icons/align-left.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.open_close_side_bar.setIcon(icon7)
...
"border-bottom: 3px solid rgb(230, 5, 64)")
        ...
        self.search.setText("")
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("qt_icons/search.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.camera.setText("")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("qt_icons/camera.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("qt_icons/arrow-down-left.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("qt_icons/maximize-2.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("qt_icons/x.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"border-radius: 5px")
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("qt_icons/github.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.kimiroshi_button.setIcon(icon13)
...
"background-color: rgba(230, 5, 64, 70)")
        ...
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("qt_icons/eye.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.show_password.setIcon(icon14)
...
"border: 3px solid rgb(230, 5, 64);\n"
"border-radius: 6px;")
        self.life_button_2.setIcon(icon1)
...
"border: 3px solid rgb(230, 5, 64);\n"
"border-radius: 6px;")
        self.clicker_button_2.setIcon(icon)
...
"border: 3px solid rgb(230, 5, 64);\n"
"border-radius: 6px;")
        self.dino_button_2.setIcon(icon2)
        self.dino_button_2.setIconSize(QtCore.QSize(16, 16))
